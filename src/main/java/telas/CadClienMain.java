 ...
 * @author TakaiJr
 */
public class CadClienMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("INSCRIÇÃO ESTADUAL/PRODUTOR RURAL/MUNICIPAL:");

        jLabel12.setText("TIPO PARA ICMS:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadClienMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadClienMain().setVisible(true);
            }
        });
    }
